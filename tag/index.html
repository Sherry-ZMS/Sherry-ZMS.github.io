...
<head>
	<link rel="bookmark"  type="image/x-icon"  href="/img/d.va_icon.png"/>
	<link rel="shortcut icon" href="/img/d.va_icon.png">
    ...
    <meta name="keywords" content="Sherry" />
    ...
    <style type="text/css">
        body:before {
          ...
          position: fixed;
          top: 0;
          background: url('/img/shiki.png') center 0 no-repeat;
          right: 0;
          bottom: 0;
          left: 0;
    ...
    <div id="wrapper" class="fade-in overlay">
        <!-- Intro 头部显示 s -->
            ...
            <h1>This is<br />
                        Mingshu ZHANG </h1>
            <p> Whatever is worth doing is worth doing well <br/> Always consider every step of the way <br/> Practice makes perfect
            </p>
            <ul class="actions">
    ...
    <a href="/" class="logo">HOME</a>
        ...
        <nav id="nav" class="special" >
			...
			<ul class="icons">
                    ...
                    <li>
                        <a title="github" href="https://github.com/Sherry-ZMS" target="_blank" rel="noopener">
                    ...
                    <section class="link_box special">
                       <a href="/2018/10/03/Profile/">
                        <div class="page_title" style="background-image: url();background-position: center; background-repeat:no-repeat; background-size:cover;-moz-background-size:cover;">
                            <!--标题-->
                            <h2 class="page_title_text"> Profile </h2>
                            <!--段落-->
                        </div>
                        </a>
                        <div class="home-post-info">
                            ...
                            <div class="home-post-info-author-avatar">
                                <h6><span class="home-post-info-data">2018-10-03</span></h6>
